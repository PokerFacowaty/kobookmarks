...
def main():
    ...
    for i, _ in enumerate(non_pdf_bookmark_data):
        ...
        final_markup_dir = combined_markups_foder / book_dir
    ...
    for pdf_path in pdf_paths:
        ...
        for pageNum, page in enumerate(doc):
            if page.first_annot:
                ...
                final_markup_dir = combined_markups_foder / pdf_path.stem
